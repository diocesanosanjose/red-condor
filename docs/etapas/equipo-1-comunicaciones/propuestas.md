# Propuestas para Red Cóndor - Equipo 1
...
- Salida de campo a Bardas Blancas para medir alcance real.
- Crear dashboard simple con datos de cobertura recolectados.

## Próximos Pasos Recomendados
- Investigar disponibilidad de hardware en Argentina.
- Contactar radioaficionados locales para asesoramiento en antenas y propagación.
- Documentar todas las mediciones de pruebas (RSSI, distancia, condiciones climáticas).
